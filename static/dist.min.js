...
function privilegesToString(e) {
    ...
    function h(e, t, n, i) {
        var o, r = 1,
            ...
            u = (he.cssNumber[t] || "px" !== c && +l) && $e.exec(he.css(e, t));
        if (u && u[3] !== c) {
            c = c || u[3], n = n || [], u = +l || 1;
    ...
    function y(e, t, n, i, o) {
        for (var r, a, s, l, c, u, d = t.createDocumentFragment(), f = [], p = 0, h = e.length; p < h; p++)
            ...
            for (a = a || d.appendChild(t.createElement("div")), s = (_e.exec(r) || ["", ""])[1].toLowerCase(), l = Xe[s] || Xe._default, a.innerHTML = l[1] + he.htmlPrefilter(r) + l[2], u = l[0]; u--;) a = a.lastChild;
        ...
        for (d.textContent = "", p = 0; r = f[p++];)
            ...
            for (u = 0; r = a[u++];) Ke.test(r.type || "") && n.push(r);
        return d
    }
    ...
    function q(e, t, n, i, o) {
        var r, a = 0;
        for (r = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0; r < 4; r += 2) "margin" === n && (a += he.css(e, n + ze[r], !0, o)), i ? ("content" === n && (a -= he.css(e, "padding" + ze[r], !0, o)), "margin" !== n && (a -= he.css(e, "border" + ze[r] + "Width", !0, o))) : (a += he.css(e, "padding" + ze[r], !0, o), "padding" !== n && (a += he.css(e, "border" + ze[r] + "Width", !0, o)));
        return a
    }
    ...
    function U(e, t, n) {
        ...
        if (l = !he.isEmptyObject(t), l || !he.isEmptyObject(p)) {
            ...
            })), l = z(g ? v[i] : 0, i, f), i in v || (v[i] = l.start, g && (l.end = l.start, l.start = 0))
        }
    }
    ...
    function W(e, t, n) {
        ...
        return he.map(u, z, c), he.isFunction(c.opts.start) && c.opts.start.call(e, c), he.fx.timer(he.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
    ...
    var ye = function(e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : z) !== F && P(t), t = t || F, q)) {
                if (11 !== h && (l = ve.exec(e)))
                    if (o = l[1]) {
                        if (9 === h) {
                ...
                if (C.qsa && !_[e + " "] && (!N || !N.test(e))) {
                    if (1 !== h) f = t, u = e;
                    else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((s = t.getAttribute("id")) ? s = s.replace(we, Ce) : t.setAttribute("id", s = $), c = A(e), r = c.length; r--;) c[r] = "#" + s + " " + p(c[r]);
        ...
        function h(e, t, n) {
            ...
            return t.first ? function(t, n, o) {
                ...
                if (l) {
                    ...
                    for (; t = t[i];)
                        if (1 === t.nodeType || a)
                            if (d = t[$] || (t[$] = {}), u = d[t.uniqueID] || (d[t.uniqueID] = {}), o && o === t.nodeName.toLowerCase()) t = t[i] || t;
                            else {
        ...
        function b(e, t, n, o, r, a) {
            return o && !o[$] && (o = b(o)), r && !r[$] && (r = b(r, a)), i(function(i, a, s, l) {
                var c, u, d, f = [],
                    p = [],
                    h = a.length,
        ...
        var w, C, k, T, S, A, E, j, R, D, O, P, F, L, q, N, M, I, H, $ = "sizzle" + 1 * new Date,
            z = e.document,
            U = 0,
            V = 0,
            W = n(),
        ...
        try {
            Y.apply(Q = Z.call(z.childNodes), z.childNodes), Q[z.childNodes.length].nodeType
        } catch (e) {
            Y = {
        ...
        C = t.support = {}, S = t.isXML = function(e) {
            ...
            return i !== F && 9 === i.nodeType && i.documentElement ? (F = i, L = F.documentElement, q = !S(F), z !== F && (n = F.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", ke, !1) : n.attachEvent && n.attachEvent("onunload", ke)), C.attributes = o(function(e) {
                return e.className = "i", !e.getAttribute("className")
            }), C.getElementsByTagName = o(function(e) {
                return e.appendChild(F.createComment("")), !e.getElementsByTagName("*").length
            }), C.getElementsByClassName = me.test(F.getElementsByClassName), C.getById = o(function(e) {
                return L.appendChild(e).id = $, !F.getElementsByName || !F.getElementsByName($).length
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !C.sortDetached && t.compareDocumentPosition(e) === n ? e === F || e.ownerDocument === z && H(z, e) ? -1 : t === F || t.ownerDocument === z && H(z, t) ? 1 : D ? ee(D, e) - ee(D, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return O = !0, 0;
                var n, i = 0,
                    o = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== F && P(e), n = n.replace(ue, "='$1']"), C.matchesSelector && q && !_[n + " "] && (!M || !M.test(n)) && (!N || !N.test(n))) try {
                var i = I.call(e, n);
            ...
            var t, n = [],
                i = 0,
                o = 0;
            if (O = !C.detectDuplicates, D = !C.sortStable && e.slice(0), e.sort(K), O) {
            ...
            filter: {
                    ...
                    return 1 === i && 0 === o ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (h = [a ? m.firstChild : m.lastChild], a && b) {
                                for (f = m, d = f[$] || (f[$] = {}), u = d[f.uniqueID] || (d[f.uniqueID] = {}), c = u[e] || [], p = c[0] === U && c[1], y = p && c[2], f = p && m.childNodes[p]; f = ++p && f && f[g] || (y = p = 0) || h.pop();)
                                    if (1 === f.nodeType && ++y && f === t) {
                                        u[e] = [U, p, y];
                                        break
                                    }
                            } else if (b && (f = t, d = f[$] || (f[$] = {}), u = d[f.uniqueID] || (d[f.uniqueID] = {}), c = u[e] || [], p = c[0] === U && c[1], y = p), y === !1)
                                for (;
                                    (f = ++p && f && f[g] || (y = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++y || (b && (d = f[$] || (f[$] = {}), u = d[f.uniqueID] || (d[f.uniqueID] = {}), u[e] = [U, y]), f !== t)););
                ...
                PSEUDO: function(e, n) {
                    ...
                    return r[$] ? r(n) : r.length > 1 ? (o = [e, e, "", n], k.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function(e, t) {
        ...
        return f.prototype = k.filters = k.pseudos, k.setFilters = new f, A = t.tokenize = function(e, n) {
            ...
            var n, i = [],
                ...
                r = _[e + " "];
            if (!r) {
                for (t || (t = A(e)), n = t.length; n--;) r = y(t[n]), r[$] ? i.push(r) : o.push(r);
                r = _(e, x(o, i)), r.selector = e
            }
            return r
        ...
        }, C.sortStable = $.split("").sort(K).join("") === $, C.detectDuplicates = !!O, P(), C.sortDetached = o(function(e) {
    ...
    he.extend({
        ...
        html: function(e) {
            return Fe(this, function(e) {
                ...
                if ("string" == typeof e && !tt.test(e) && !Xe[(_e.exec(e) || ["", ""])[1].toLowerCase()]) {
    ...
    he.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, r, a, s = he.camelCase(t),
                    l = e.style;
                return t = he.cssProps[s] || (he.cssProps[s] = F(s) || s), a = he.cssHooks[t] || he.cssHooks[s], void 0 === n ? a && "get" in a && void 0 !== (o = a.get(e, !1, i)) ? o : l[t] : (r = typeof n, "string" === r && (o = $e.exec(n)) && o[1] && (n = h(e, t, o), r = "number"), void(null != n && n === n && ("number" === r && (n += o && o[3] || (he.cssNumber[s] ? "" : "px")), fe.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, i)) || (l[t] = n))))
            }
        },
        ...
        he.cssHooks[t] = {
            ...
            set: function(e, n, i) {
                ...
                return a && (o = $e.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = he.css(e, t)), L(e, n, a)
            }
        }
    ...
    he.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : he.isFunction(e) ? this.each(function(n) {
                ...
                else void 0 !== e && "boolean" !== n || (t = _(this), t && qe.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : qe.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, n, i = 0;
    ...
    he.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !he(this).is(":disabled") && Rt.test(this.nodeName) && !jt.test(e) && (this.checked || !Be.test(e))
            }).map(function(e, t) {
                var n = he(this).val();
    ...
    fe.cors = !!Ut && "withCredentials" in Ut, fe.ajax = Ut = !!Ut, he.ajaxTransport(function(t) {
        ...
        if (fe.cors || Ut && !t.crossDomain) return {
            send: function(o, r) {
                ...
                n = function(e) {
                    return function() {
                        n && (n = i = s.onload = s.onerror = s.onabort = s.onreadystatechange = null, "abort" === e ? s.abort() : "error" === e ? "number" != typeof s.status ? r(0, "error") : r(s.status, s.statusText) : r(zt[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
                            binary: s.response
                        } : {
                            text: s.responseText
    ...
    he.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return o = t.jsonpCallback = he.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Wt, "$1" + o) : t.jsonp !== !1 && (t.url += (St.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function() {
        ...
        var i, o, r, a = this,
            s = e.indexOf(" ");
        return s > -1 && (i = B(e.slice(s)), e = e.slice(0, s)), he.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), a.length > 0 && he.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
    ...
    return he.noConflict = function(t) {
        return e.$ === he && (e.$ = _t), t && e.jQuery === he && (e.jQuery = Bt), he
    }, t || (e.jQuery = e.$ = he), he
}),
/**
    ...
    t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.dropdown = function(o) {
        ...
        return a.each(function(g) {
            ...
            k = {
                ...
                destroy: function() {
                    k.verbose("Destroying previous dropdown", M), k.remove.tabbable(), M.off(q).removeData(N), B.off(q), s.off(y), k.disconnect.menuObserver(), k.disconnect.selectObserver()
                },
                observeChanges: function() {
                ...
                setup: {
                    ...
                    select: function() {
                        ...
                        k.debug("Dropdown initialized on a select", t), M.is("select") && (U = M), U.parent(P.dropdown).length > 0 ? (k.debug("UI dropdown already exists. Creating dropdown menu only"), M = U.closest(P.dropdown), k.has.menu() || k.create.menu(), B = M.children(P.menu), k.setup.menu(t)) : (k.debug("Creating entire dropdown from select"), M = e("<div />").attr("class", U.attr("class")).addClass(S.selection).addClass(S.dropdown).html(L.dropdown(t)).insertBefore(U), U.hasClass(S.multiple) && U.prop("multiple") === !1 && (k.error(F.missingMultiple), U.prop("multiple", !0)), U.is("[multiple]") && k.set.multiple(), U.prop("disabled") && (k.debug("Disabling dropdown"), M.addClass(S.disabled)), U.removeAttr("class").detach().prependTo(M)), k.refresh()
                    },
                    menu: function(e) {
                        B.html(L.menu(e, E)), _ = B.find(P.item)
                    },
                    reference: function() {
                ...
                refreshData: function() {
                    k.verbose("Refreshing cached metadata"), _.removeData(R.text).removeData(R.value)
                },
                clearData: function() {
                    k.verbose("Clearing metadata"), _.removeData(R.text).removeData(R.value), M.removeData(R.defaultText).removeData(R.defaultValue).removeData(R.placeholderText)
                },
                toggle: function() {
                ...
                bind: {
                    ...
                    touchEvents: function() {
                        k.debug("Touch device detected binding additional touch events"), k.is.searchSelection() || k.is.single() && M.on("touchstart" + q, k.event.test.toggle), B.on("touchstart" + q, P.item, k.event.item.mouseenter)
                    },
                ...
                focusSearch: function(e) {
                    k.has.search() && !k.is.focusedOnSearch() && (e ? (M.off("focus" + q, P.search), $.focus(), M.on("focus" + q, P.search, k.event.search.focus)) : $.focus())
                },
                ...
                event: {
                    ...
                    blur: function(e) {
                        v = n.activeElement === this, K || v || (k.remove.activeLabel(), k.hide())
                    },
                    mousedown: function() {
                    ...
                    search: {
                        focus: function() {
                            K = !0, k.is.multiple() && k.remove.activeLabel(), T.showOnFocus && k.search()
                        },
                        blur: function(e) {
                            v = n.activeElement === this, b || X || v || (T.forceSelection && k.forceSelection(), k.hide()), b = !1
                        }
                    },
                    icon: {
                        click: function(e) {
                    ...
                    keydown: function(e) {
                        var t = e.which,
                            n = k.is.inObject(t, j);
                        if (n) {
                            var i, o, r = _.not(P.unselectable).filter("." + S.selected).eq(0),
                            ...
                            if (m && (k.verbose("Selecting item from keyboard shortcut", s), k.event.item.click.call(s, e), k.is.searchSelection() && k.remove.searchTerm()), k.is.visible()) {
                                if ((t == j.enter || g) && (t == j.enter && p && f && !T.allowCategorySelection ? (k.verbose("Pressed enter on unselectable category, opening sub menu"), t = j.rightArrow) : h && (k.verbose("Selecting item from keyboard shortcut", s), k.event.item.click.call(s, e), k.is.searchSelection() && k.remove.searchTerm()), e.preventDefault()), p && (t == j.leftArrow && (o = u[0] !== B[0], o && (k.verbose("Left key pressed, closing sub-menu"), k.animate.hide(!1, u), s.removeClass(S.selected), u.closest(P.item).addClass(S.selected), e.preventDefault())), t == j.rightArrow && f && (k.verbose("Right key pressed, opening sub-menu"), k.animate.show(!1, c), s.removeClass(S.selected), c.find(P.item).eq(0).addClass(S.selected), e.preventDefault())), t == j.upArrow) {
                                    if (i = p && d ? s.prevAll(P.item + ":not(" + P.unselectable + ")").eq(0) : _.eq(0), l.index(i) < 0) return k.verbose("Up key pressed but reached top of current menu"), void e.preventDefault();
                                ...
                                if (t == j.downArrow) {
                                    if (i = p && d ? i = s.nextAll(P.item + ":not(" + P.unselectable + ")").eq(0) : _.eq(0), 0 === i.length) return k.verbose("Down key pressed but reached bottom of current menu"), void e.preventDefault();
                                    k.verbose("Down key pressed, changing active item"), _.removeClass(S.selected), i.addClass(S.selected), k.set.scrollPosition(i), T.selectOnKeydown && k.is.single() && k.set.selectedItem(i), e.preventDefault()
                                }
                ...
                add: {
                    ...
                    userSuggestion: function(e) {
                        ...
                        if (!T.useLabels || !k.has.maxSelections()) {
                            ...
                            r ? (n.data(R.value, e).data(R.text, e).attr("data-" + R.value, e).attr("data-" + R.text, e).removeClass(S.filtered), T.hideAdditions || (t = T.templates.addition(k.add.variables(A.addResult, e)), n.html(t)), k.verbose("Replacing user suggestion with new value", n)) : (n = k.create.userChoice(e), n.prependTo(B), k.verbose("Adding item choice to menu corresponding with user choice addition", n)), T.hideAdditions && !k.is.allFiltered() || n.addClass(S.selected).siblings().removeClass(S.selected), k.refreshItems()
                        }
                    },
    ...
    singlePageSnippets = {
        ...
        "/leaderboard": function() {
            function e() {
                ...
                window.history.replaceState("", document.title, e.pathname + "?mode=" + favouriteMode + "&p=" + page + ("" != country ? "&country=" + encodeURI(country) : "") + e.hash), api("leaderboard", {
                    mode: favouriteMode,
                    p: page,
                    l: 50,
                    country: country
		...
		"/leaderboard/score": function() {
            function e() {
                var e = window.location;
                window.history.replaceState("", document.title, e.pathname + "?mode=" + favouriteMode + "&p=" + page + ("" != country ? "&country=" + encodeURI(country) : "") + e.hash), api("scoreleaderboard", {
                    mode: favouriteMode,
                    p: page,
                    l: 50,
                    country: country
                    ...
                    var i = 0;
                    e.users.forEach(function(e) {
                        n.append($("<tr />").append($("<td />").text("#" + (50 * (page - 1) + ++i)), $("<td />").html("<a href='/u/" + e.id + "' title='View profile'><i class='" + e.country.toLowerCase() + " flag'></i>" + escapeHTML(e.username) + "</a>"), $("<td />").html(t(e.chosen_mode.pp, e.chosen_mode.ranked_score)), $("<td />").text(e.chosen_mode.accuracy.toFixed(2) + "%"), $("<td />").html(addCommas(e.chosen_mode.playcount) + " <i title='" + T("Why, LOVE, of course!") + "'>(lv. " + e.chosen_mode.level.toFixed(0) + ")</i>")))
                    }), disableSimplepagButtons(e.users.length < 50)
                })
            }

            function t(e, t) {
                return 0 === t ? "<b>" + addCommas(e) + "</b>" : "<b>" + addCommas(t) + "</b> (" + addCommas(e) + "pp)"
            }
            page = 0 === page ? 1 : page, $("#country-chooser-modal").click(function() {
                $(".ui.modal").modal("show")
            }), $(".lb-country").click(function() {
        ...
        "/leaderboard/coins": function() {
            function e() {
                var e = window.location;
                window.history.replaceState("", document.title, e.pathname + "?mode=" + favouriteMode + "&p=" + page + ("" != country ? "&country=" + encodeURI(country) : "") + e.hash), api("coinsleaderboard", {
                    mode: favouriteMode,
                    p: page,
                    l: 50,
                    country: country
                    ...
                    var i = 0;
                    e.users.forEach(function(e) {
                        n.append($("<tr />").append($("<td />").text("#" + (50 * (page - 1) + ++i)), $("<td />").html("<a href='/u/" + e.id + "' title='View profile'><i class='" + e.country.toLowerCase() + " flag'></i>" + escapeHTML(e.username) + "</a>"), $("<td />").html(t(e.chosen_mode.coins)), $("<td />").text(e.chosen_mode.accuracy.toFixed(2) + "%"), $("<td />").html(addCommas(e.chosen_mode.playcount) + " <i title='" + T("Why, LOVE, of course!") + "'>(lv. " + e.chosen_mode.level.toFixed(0) + ")</i>")))
                    }), disableSimplepagButtons(e.users.length < 50)
                })
            }
        ...
        "/settings": function() {
            ...
            $("form").submit(function(t) {
                ...
                if (n != e) {
                    ...
                    i = n ? 1 | +i : +i & -2, document.cookie = "cflags=" + i + ";path=/;max-age=31536000"
                }
                ...
                return api("users/self/settings", o, function(t) {
                    return n != e ? void window.location.reload() : (showMessage("success", "Your new settings have been saved."), void a.removeClass("loading"))
                }, !0), !1
            })
        },
