(window.webpackJsonp = window.webpackJsonp || []).push([
    [0], {
        ...
        24: function(e, t, a) {
            ...
            var s = a(0),
                ...
                k = {
                    api_beatmaps_request: function(e, t) {
                        return fetch("http://pisstau.be/api/".concat(e), {
                            method: "get",
                            cache: "default"
                        }).then(h).then(f).then(t)
                    }
                },
                p = (a(18), a(8)),
                E = a.n(p),
                b = function(e) {
                        ...
                        return Object(c.a)(this, t), (a = Object(o.a)(this, Object(u.a)(t).call(this, e))).renderDummyData = function() {
                            var e = a.state.beatmaps.map(function(e, t) {
                                ...
                                return n.a.createElement("div", {
                                    ...
                                    href: "https://enjuu.click/b/" + e.ChildrenBeatmaps[e.ChildrenBeatmaps.length - 1].BeatmapID
                                    ...
                                    href: "https://cg.mxr.lol/d/" + e.ChildrenBeatmaps[e.ChildrenBeatmaps.length - 1].ParentSetID,
                                    className: "download"
                                }, n.a.createElement("i", {
                    ...
                    return Object(m.a)(t, e), Object(l.a)(t, [{
                        ...
                        value: function() {
                            var e = this;
                            k.api_beatmaps_request("search?offset=" + this.state.offset + "&amount=" + this.state.count + "&mode=" + this.state.mode + "&status=" + this.state.status + "&query=" + this.state.query, function(t) {
                                e.setState({
                                    loading: !1,
                                    beatmaps: t
                                })
            ...
            r.a.render(n.a.createElement(b, null), document.getElementById("react-app"))
        }
    },
    [
        [11, 2, 1]
